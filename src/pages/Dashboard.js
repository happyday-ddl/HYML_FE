...
function PlasticBagSVG({ size = 32 }) {
  return (
    ...
    >
      <path
        d="M14 8 Q11 2 18 2 Q25 2 22 8"
        stroke="#cce5ff"
        strokeWidth="1.5"
        fill="none"
      />
      <path
        d="M8 10 Q6 30 8 42 Q13 46 18 46 Q23 46 28 42 Q30 30 28 10 Z"
        fill="rgba(200,230,255,0.55)"
        stroke="#90c8f8"
        strokeWidth="1.2"
      />
      <path
        d="M11 18 Q18 22 25 18"
        stroke="#90c8f8"
        strokeWidth="1"
        fill="none"
        opacity="0.7"
...
function PlasticBottleSVG({ size = 28 }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M7 8 Q5 14 5 20 L5 52 Q5 58 14 58 Q23 58 23 52 L23 20 Q23 14 21 8 Z"
        fill="rgba(168,216,168,0.5)"
        stroke="#6dbf6d"
        strokeWidth="1.2"
      />
      <ellipse cx="14" cy="30" rx="7" ry="3" fill="rgba(255,255,255,0.2)" />
      <path
        d="M7 20 Q14 23 23 20"
        stroke="#6dbf6d"
        strokeWidth="0.8"
        fill="none"
        opacity="0.6"
...
function FishingNetSVG({ size = 38 }) {
  return (
    ...
    >
      <path
        d="M2 2 Q22 10 42 2 Q38 20 42 36 Q22 28 2 36 Q6 18 2 2 Z"
        fill="rgba(200,200,100,0.25)"
        stroke="#c8b400"
        strokeWidth="1.2"
      />
      {[0, 1, 2].map((r) => (
        <path
          key={r}
          d={`M2 ${12 + r * 8} Q22 ${18 + r * 4} 42 ${12 + r * 8}`}
          stroke="#c8b400"
          strokeWidth="0.8"
          fill="none"
          opacity="0.7"
      ...
      {[0, 1, 2, 3].map((c) => (
        <path
          key={c}
          d={`M${10 + c * 8} 2 Q${10 + c * 6} 20 ${10 + c * 8} 36`}
          stroke="#c8b400"
          strokeWidth="0.8"
          fill="none"
          opacity="0.7"
  ...
  return (
    ...
    >
      ...
      {[9, 16, 23, 30, 37].map((x, i) => (
        <path
          key={i}
          d={`M${x} 26 C${x - 5} ${40 + i} ${x + 3} ${50 + i} ${x - 1} ${62 + i}`}
          stroke="#e0aaff"
          strokeWidth="1.5"
          fill="none"
          opacity="0.75"
...
function CrabSVG({ size = 44 }) {
  return (
    ...
    >
      ...
      <path
        d="M13 22 Q5 16 2 10 Q7 6 12 13 Q13 9 18 13 Q14 17 13 22 Z"
        fill="#e63946"
      />
      <path
        d="M51 22 Q59 16 62 10 Q57 6 52 13 Q51 9 46 13 Q50 17 51 22 Z"
        fill="#e63946"
      />
      <line
        x1="16"
...
function TurtleSVG({ size = 58 }) {
  return (
    ...
    >
      ...
      <path
        d="M31 21 L42 17 L53 21 L53 39 L42 43 L31 39 Z"
        fill="#52b788"
        opacity="0.4"
      />
...
function SeahorseSVG({ size = 38 }) {
  return (
    ...
    >
      ...
      <path
        d="M22 22 Q32 30 30 50 Q28 65 20 75 Q16 68 18 54 Q14 40 22 22 Z"
        fill="#f77f00"
      />
      <path
        d="M13 30 Q4 34 6 44 Q14 40 16 30 Z"
        fill="#f77f00"
        opacity="0.75"
      />
      {[0, 1, 2, 3, 4].map((i) => (
        <path
          key={i}
          d={`M16 ${36 + i * 7} Q24 ${34 + i * 7} 30 ${38 + i * 7}`}
          stroke="#d62828"
          strokeWidth="1.2"
          fill="none"
          opacity="0.5"
...
function getCreatures(level) {
  ...
  if (level >= 7)
    list.push({ type: "seahorse", left: "38%", top: "16%", size: 36 });
  if (level >= 7)
    list.push({
      type: "fish",
      swimIdx: 6,
      ...
      <div style={oceanStyles.sceneCol}>
        ...
        >
          ...
          <div style={oceanStyles.seabed}>
            ...
            {level >= 5 && (
              <div
                style={{
                  ...
                  left: "44%",
                  zIndex: 4,
                  animation: "crabWalk 3.5s ease-in-out infinite",
                  pointerEvents: "none",
                }}
              >
                <CrabSVG size={34} />
            ...
            {[
              ...
              <div
                key={i}
                style={{ position: "absolute", bottom: 0, left: l, zIndex: 1 }}
              >
                <RockSVG
                  w={w}
                  h={h}
                  dark={i % 2 === 0 ? "#3a3535" : "#2e2828"}
                  light={i % 2 === 0 ? "#5c5454" : "#4a4040"}
                />
              </div>
            ))}
          </div>
        ...
        <div style={oceanStyles.progressBar}>
          <div style={oceanStyles.progressLabel}>
            Total Echo Points:{" "}
            <strong style={{ color: selMeta.color }}>
              {groupPoints.toLocaleString()}
            </strong>
            &nbsp;·&nbsp; Level{" "}
            <strong style={{ color: "#90e0ef" }}>{level}</strong>
            &nbsp;·&nbsp; Next milestone:{" "}
            <strong style={{ color: "#f59e0b" }}>
              {((level + 1) * 1000).toLocaleString()} pts
            </strong>
          </div>
          <div style={oceanStyles.milestoneTrack}>
            <div
              style={{
                ...oceanStyles.milestoneFill,
                width: `${((groupPoints % 1000) / 1000) * 100}%`,
                background: `linear-gradient(90deg, ${selMeta.color}, ${selMeta.border})`,
              }}
            />
          </div>
        </div>
...
export default function Dashboard() {
  ...
  function getMissionDetails(ev) {
    return {
      ...
      requirement:
        ev.requirement ||
        "Bring a phone for check-in and wear comfortable clothes.",
    };
  }
              ...
              style={{
                ...
                background:
                  activeTab === item.id
                    ...
                    : "transparent",
                color:
                  activeTab === item.id ? "#90e0ef" : "rgba(200,230,255,0.55)",
                borderLeft:
                  activeTab === item.id
                    ? "2px solid #48cae4"
        ...
        <div style={styles.mainHeader}>
          <div>
            ...
            <p style={styles.mainSub}>
              {activeTab === "missions" &&
                "Complete missions to earn echo points for your group"}
              {activeTab === "leaderboard" &&
                "Groups ranked by echo points this season"}
              {activeTab === "attend" &&
                "Enter your event code to log attendance and earn points"}
            </p>
          </div>
          <div
            style={{
          ...
          <div style={styles.content}>
            ...
            <div style={styles.subTabBar}>
              <button
                style={{
                  ...styles.subTabBtn,
                  ...(lbSubTab === "ranking" ? styles.subTabActive : {}),
                }}
              ...
              <button
                style={{
                  ...styles.subTabBtn,
                  ...(lbSubTab === "ocean" ? styles.subTabActive : {}),
                }}
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: isMe
                          ...
                          : "1px solid rgba(72,202,228,0.08)",
                        background: isMe
                    ...
                    >
                      ...
                      <div style={styles.leaderInfo}>
                        ...
                        <p style={styles.memberCount}>
                          {(entry.members || 0).toLocaleString()} members
                        </p>
                      </div>
                    </div>
                  );
          ...
          <div style={styles.content}>
            <div style={styles.attendCard}>
              ...
              <p style={styles.attendSub}>
                Get your event code from the organizer at the event. Enter it
                below to log your attendance and earn echo points.
              </p>
              ...
              {attendResult && (
                <div
                  style={{
                    ...styles.attendResult,
                    background: attendResult.ok
                      ? "rgba(16,185,129,0.15)"
                      : "rgba(239,68,68,0.15)",
                    borderColor: attendResult.ok
                      ? "rgba(16,185,129,0.4)"
                      : "rgba(239,68,68,0.4)",
...
const styles = {
  page: {
    minHeight: "100vh",
    background:
      "linear-gradient(135deg, #020b18 0%, #041428 50%, #061e3a 100%)",
    color: "#e8f4fd",
    display: "flex",
    position: "relative",
  },
  bgGlow: {
    ...
    inset: 0,
    background:
      "radial-gradient(ellipse 60% 40% at 70% 20%, rgba(0,70,140,0.15) 0%, transparent 60%)",
    pointerEvents: "none",
  },
  sidebar: {
    width: "220px",
  ...
  eventCard: {
    ...
    padding: "20px 24px",
    background:
      "linear-gradient(145deg, rgba(10,28,65,0.7), rgba(5,16,40,0.85))",
...
const oceanStyles = {
  ...
  ray: {
    ...
    height: "100%",
    background:
      "linear-gradient(180deg, rgba(255,240,180,0.12) 0%, transparent 100%)",
  ...
  seabed: {
    ...
    height: "80px",
    background:
      "linear-gradient(180deg, transparent 0%, rgba(20,10,0,0.6) 100%)",
    display: "flex",
    alignItems: "flex-end",
  },
  coral: {
